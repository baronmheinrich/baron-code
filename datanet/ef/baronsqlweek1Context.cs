...
{
    public partial class baronsqlweek1Context : DbContext
    {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer(@"server=mysqlweek1.database.windows.net;database=baronsqlweek1;user id=sqladmin001;password=MyPassword1!");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<email>(entity =>
            {
                ...
                entity.Property(e => e.ChangedDate).HasComputedColumnSql("(sysutcdatetime())");
